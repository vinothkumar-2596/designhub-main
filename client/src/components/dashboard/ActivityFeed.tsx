...
export function ActivityFeed({ notifications }: ActivityFeedProps) {
    ...
    return (
        <div className="relative overflow-hidden rounded-[32px] border border-slate-100 bg-white dark:bg-card dark:border-border p-2 shadow-xl shadow-slate-200/50 dark:shadow-[0_22px_50px_-28px_rgba(0,0,0,0.6)] flex flex-col">
            ...
            <div className="relative h-64 w-full overflow-hidden rounded-[24px] bg-slate-50/50 dark:bg-muted/40">
                ...
                <div className="absolute inset-0 flex items-center justify-center p-6">
                    <div className="relative w-full max-w-sm rounded-[24px] border border-white/40 dark:border-border bg-white/40 dark:bg-card/70 backdrop-blur-xl shadow-xl shadow-indigo-500/5 p-6">
                        ...
                        {hasActivity ? (
                            enableScroll ? (
                                <ScrollArea className="max-h-[168px] pr-2">
